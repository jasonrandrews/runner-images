...
if is_ubuntu20; then
    ...
    download_url="https://github.com/aliyun/aliyun-cli/releases/download/v$toolset_version/aliyun-cli-linux-$toolset_version-arm64.tgz"
else
    download_url=$(resolve_github_release_asset_url "aliyun/aliyun-cli" "contains(\"aliyun-cli-linux\") and endswith(\"arm64.tgz\")" "latest")
...
if is_ubuntu20; then
    ...
    external_hash=$(get_checksum_from_url "$hash_url" "aliyun-cli-linux.*arm64.tgz" "SHA256")
fi
